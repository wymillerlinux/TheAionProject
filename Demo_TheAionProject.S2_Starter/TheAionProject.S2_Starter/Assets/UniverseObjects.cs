    ...
    public static class UniverseObjects
    {
        public static IEnumerable<SpaceTimeLocation> SpaceTimeLocations = new List<SpaceTimeLocation>()
        {
            ...
            new SpaceTimeLocation
            {
                ...
                UniversalDate = 386759,
                UniversalLocation = "P-?, SS-?, G-?, LS-0000",
                Description = "Where no living soul has gone before. Doom, also known as Hell, " +
                              "is a whole different dimension where you typically have a big weapon " +
                              "and slaughter demons or is that just a video game I'm referencing?",
